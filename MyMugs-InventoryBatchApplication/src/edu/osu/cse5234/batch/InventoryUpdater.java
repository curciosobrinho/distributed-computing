...
public class InventoryUpdater {
	...
	private static Connection createConnection() throws SQLException, ClassNotFoundException {
		...
		Connection conn = DriverManager.getConnection("jdbc:h2:/Users/curciojamunda/Dev/java/eclipse-workspace/h2/MyMugs;AUTO_SERVER=TRUE;DB_CLOSE_ON_EXIT=FALSE", "sa", "");
		return conn;
	}
