...
public class IWorkWithJSPServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getSession().getAttribute("counter") != null) {
			counter = request.getSession().getAttribute("counter").toString();
		}
		...
		String greeting = "Welcome to the party "+name;
		
		greeting +="<br><br>You visited our party "+counter+" times";
